...
public class PasswordMain extends BorderPane
{
	...
	public PasswordMain()
	{
		...
		instruction6Label = new Label("\t5.  Must contain at least one special charcter");//added because was not included in original program
	...
	public void readFile() {
		...
		if (selectedFile != null) {
			...
			try {
				...
				// JOptionPane not working on macOS 12.0.1 (M1 Mac)
